...
img_onnx_path = '/data/beit3_trt_convert/onnx_models/beit3_retrival_coco_img.onnx'
text_onnx_path = '/data/beit3_trt_convert/onnx_models/beit3_retrival_coco_text.onnx'
input_size = 384
...
ort_session = ort.InferenceSession(img_onnx_path, providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
...
ort_session_text = ort.InferenceSession(text_onnx_path, providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
...
print(f"token_tensor_shape: {token_ids_tensor0.shape}")
print(f"padding_mask_tensor0: {padding_mask_tensor0.shape}")
print('token_ids_tensor0', token_ids_tensor0)
print('padding_mask_tensor0', padding_mask_tensor0)
