...
if __name__ == '__main__':
    ...
    input_text_onnx_path = '/data/caoxh/code/my_beit3_convert/model_weights/beit3_retrival_coco_text_constant.onnx'
    ...
    text_fp32_trt_path = '/data/caoxh/code/my_beit3_convert/tensorrt_models/beit3_retrival_coco_text_fp16_mine.trt'
